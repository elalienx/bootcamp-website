        ...
        onInit() {
          ...
          for (let t = 0; t < 80; t++) {
            const t = Object(o.h)(18, 24),
              ...
              h = Math.sin(n) * s,
              a = Math.cos(n) * s;
            u.vertices.push(new r.Vector3(a * t, h * t, i * t)),
              u.vertices.push(new r.Vector3(a * e, h * e, i * e));
          }
          (this.linesMesh2 = new r.LineSegments(u, l)),
            this.linesMesh2.position.set(0, 0, 0),
            this.cont2.add(this.linesMesh2);
          const p = new r.LineBasicMaterial({
          ...
          (this.linesMesh3 = new r.LineSegments(d, p)),
          ...
          for (let t = 0; t < this.points.length; t++) {
            ...
            const c = this.points[t],
              u = (n = this.rayCaster
                ...
                : 1e3).clamp(5, 15);
            (c.scale.z = (0.25 * (15 - u)).clamp(1, 100)),
              (c.scale.x = c.scale.y = c.scale.z),
              (c.position.y =
                2 *
                Math.sin(
                  c.position.x / 10 + 0.01 * this.t + (c.position.z / 10) * 0.5
                ));
